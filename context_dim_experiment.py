from policy_evaluation.Environment import *
from policy_evaluation.Estimator import *
from policy_evaluation.Policy import *
from policy_evaluation.ParameterSelector import *
import numpy as np
import pandas as pd
...
import os
import sys
from doubly_robust_method.policy_eval_dr_cfme import DRCFMEstimator
...
if __name__ == "__main__":
    ...
    """ 
     ...
     """
    estimators = [DRCFMEstimator(rbf_kernel,rbf_kernel,null_policy, target_policy,params),
    ...
    #     compare_df=compare_estimators(estimators, null_policy, target_policy, environment, item_vectors,
    #                                        config, seeds[i])
    ...
    if not os.path.exists('context_dim_report'):
        os.makedirs("context_dim_report/results")
